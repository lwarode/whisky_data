...
# scotland_map <- ne_countries(country = "united kingdom", 
#                              returnclass = "sf", 
#                              type = "map_units", 
#                              scale = "medium") %>% 
#    filter(name == "Scotland") 
# 
# uk_map <- ne_countries(country = "united kingdom", 
#                              returnclass = "sf", 
#                              scale = "medium") 
# 
# uk_map
...
ggplot() + 
   ...
   geom_text_repel(data = subset(whisky_sf, Smoky == 4), 
                   ...
                   nudge_x = -1,
                   nudge_y = 0.125) +
   scale_color_ordinal(direction = -1, name = "Smokiness") + 
   annotate("rect", xmin = - 8, xmax = -6, ymin = 59.5, ymax = 60.5, 
            alpha = 0.5, 
            fill = "antiquewhite",
            color = "antiquewhite4") +
   annotate("text", x = - 7, y = 60, label = "Smoky", size = 10) +
   coord_sf(x = c(-8, 0),
            y = c(53, 61)) +
   labs(x = "", y = "")
```
